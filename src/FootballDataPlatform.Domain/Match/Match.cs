...
public sealed class Match
{
    ...
    private static void ValidateIdentity(Guid seasonId, Guid homeTeamId, Guid awayTeamId)
    {
        if (seasonId == Guid.Empty)
            throw new ArgumentException("Season is required.", nameof(seasonId));
        if (homeTeamId == Guid.Empty)
            throw new ArgumentException("Home team is required.", nameof(homeTeamId));
        if (awayTeamId == Guid.Empty)
            throw new ArgumentException("Away team is required.", nameof(awayTeamId));
