...
public class CompetitionTests
{
    ...
    {
        Assert.Throws<ArgumentException>(() => new Competition("", "England", "EPL"));
    }

    [Fact]
    public void Constructor_WithEmptyCountry_Throws()
    {
        Assert.Throws<ArgumentException>(() => new Competition("Premier League", "", "EPL"));
    }

    [Fact]
    public void Constructor_WithEmptyCode_Throws()
    {
        Assert.Throws<ArgumentException>(() => new Competition("Premier League", "England", ""));
    }
